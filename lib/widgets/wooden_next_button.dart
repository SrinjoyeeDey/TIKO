...
class WoodenNextButton extends StatefulWidget {
  final VoidCallback onTap;
  final double size;

  const WoodenNextButton({
    super.key,
    required this.onTap,
    this.size = 64.0,
  });
  ...
  @override
  State<WoodenNextButton> createState() => _WoodenNextButtonState();
}

class _WoodenNextButtonState extends State<WoodenNextButton> {
      ...
      child: AnimatedScale(
        ...
        child: Container(
          ...
          child: CustomPaint(
            ...
            painter: _WoodenNextButtonPainter(),
          ),
        ),
      ),
    );
...
class _WoodenNextButtonPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    final w = size.width;
    final h = size.height;

    // 1. Shadow for Carved Wooden Outer Triangle
    ...
    // 4. Glossy Golden Yellow Play Arrow Triangle
