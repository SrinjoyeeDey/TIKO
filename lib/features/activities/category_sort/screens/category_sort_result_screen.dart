...
/// Result Screen for Category Sort FFC activity.
class CategorySortResultScreen extends StatefulWidget {
  final ActivitySession session;

  const CategorySortResultScreen({
    super.key,
    required this.session,
  });

  @override
  State<CategorySortResultScreen> createState() => _CategorySortResultScreenState();
}

class _CategorySortResultScreenState extends State<CategorySortResultScreen> {
  @override
  void initState() {
    super.initState();
    // Sync profile XP
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Your semantic categorization skills are razor sharp!',
                  style: GoogleFonts.outfit(
                    fontSize: 13,
