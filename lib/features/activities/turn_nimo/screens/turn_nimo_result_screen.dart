...
/// Result Screen for Turn NIMO social activity.
class TurnNimoResultScreen extends StatefulWidget {
  final ActivitySession session;

  const TurnNimoResultScreen({
    super.key,
    required this.session,
  });

  @override
  State<TurnNimoResultScreen> createState() => _TurnNimoResultScreenState();
}

class _TurnNimoResultScreenState extends State<TurnNimoResultScreen> {
  @override
  void initState() {
    super.initState();
    // Sync profile XP
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Awesome turn-taking! Social interaction unlocked.',
                  style: GoogleFonts.outfit(
                    fontSize: 13,
