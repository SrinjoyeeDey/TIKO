...
/// Result Screen for Remember NIMO.
class RememberNimoResultScreen extends StatefulWidget {
  final ActivitySession session;

  const RememberNimoResultScreen({
    super.key,
    required this.session,
  });

  @override
  State<RememberNimoResultScreen> createState() => _RememberNimoResultScreenState();
}

class _RememberNimoResultScreenState extends State<RememberNimoResultScreen> {
  @override
  void initState() {
    super.initState();
    // Sync profile XP
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Your memory streak is getting stronger.',
                  style: GoogleFonts.outfit(
                    fontSize: 13,
