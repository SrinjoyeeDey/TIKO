...
/// Result Screen for Find NIMO.
class FindNimoResultScreen extends StatefulWidget {
  final ActivitySession session;

  const FindNimoResultScreen({
    super.key,
    required this.session,
  });

  @override
  State<FindNimoResultScreen> createState() => _FindNimoResultScreenState();
}

class _FindNimoResultScreenState extends State<FindNimoResultScreen> {
  @override
  void initState() {
    super.initState();
    // Sync profile XP
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      ...
                      _buildStatCard(
                        icon: '🔥',
                        label: 'SUCCESSFUL',
                        value: '${session.successfulRounds}',
